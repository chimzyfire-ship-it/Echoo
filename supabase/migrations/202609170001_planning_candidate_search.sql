-- The discovery RPC aggregates province-wide engagement signals. That is too
-- expensive for several constrained planning lookups. Planning retrieves a
-- bounded local set and applies its own profile/hours/price ranking afterward.
create function public.search_planning_places(
