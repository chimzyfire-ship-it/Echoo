  ...
  return (
    ...
    >
      <View style={styles.hero}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Close place details" onPress={() => router.back()} style={[styles.closeButton, { top: Math.max(insets.top, 44) + 6 }]}><X size={21} color={Colors.ink} /></Pressable>
